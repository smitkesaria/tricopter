...
SCS_MINIMUM_POSITION_VALUE  = 1536           # SC Servo will rotate between this value
SCS_MAXIMUM_POSITION_VALUE  = 2560
SCS_MOVING_SPEED            = 1400        # SC Servo moving speed
...
while 1:
    ...
    while 1:
        ...
        if scs_comm_result != COMM_SUCCESS:
            ...
            pass
            print("[ID:%03d] GoalPos:%d PresPos:%d PresSpd:%d" % (SCS_ID, scs_goal_position[index], scs_present_position, scs_present_speed), end = '\r')
        if scs_error != 0:
